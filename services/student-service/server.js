...
process.env.SERVICE_NAME = 'student-service';
...
const app = express();
const PORT = process.env.PORT || process.env.STUDENT_SERVICE_PORT || 3001;
...
// Health check
app.get('/health', (req, res) => res.json({ status: 'ok', service: 'student-service', ts: Date.now() }));
